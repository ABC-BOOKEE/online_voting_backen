...
// console.log(`hollauuuuuuuuuuuuuuuuuuuuuuuuuuuuuu ${wallet}`)
...
module.exports = async ({ deployments }) => {
    ...
    //deploy Simplecoin
    const SimpleCoin = await ethers.getContractFactory("CollegeVoting")
    console.log("Deploying college voting ...")
